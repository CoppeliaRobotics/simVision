...
bool trigger,string packedDataPacket=simVision.binaryWorkImg(int visionSensorHandle,float threshold,float oneProportion,float oneTol,float xCenter,float xCenterTol,float yCenter,float yCenterTol,float orient,float orientTol,float roundness,bool enableTrigger,float[3] overlayColor={1.0,0.0,1.0})
bool trigger,string packedDataPacket=simVision.blobDetectionOnWorkImg(int visionSensorHandle,float threshold,float minBlobSize,bool modifyWorkImage,float[3] overlayColor={1.0,0.0,1.0})
simVision.buffer1ToWorkImg(int visionSensorHandle)
simVision.buffer2ToWorkImg(int visionSensorHandle)
bool trigger,string packedDataPacket=simVision.changedPixelsOnWorkImg(int visionSensorHandle,float threshold)
...
bool trigger,string packedDataPacket,string colorData=simVision.coordinatesFromWorkImg(int visionSensorHandle,int[2] xyPointCount,bool evenlySpacedInAngularSpace,bool returnColorData=false)
...
float[] points,string colorData=simVision.handleVelodyneHDL64E(int velodyneHandle,float dt)
float[] points,string colorData=simVision.handleVelodyneVPL16(int velodyneHandle,float dt)
...
bool trigger,string packedDataPacket,string colorData=simVision.velodyneDataFromWorkImg(int visionSensorHandle,int[2] xyPointCount,float vAngle,bool returnColorData=false)
