...
{
public:
    CVisionVelodyneVPL16(int scriptHandle,const int visionSensorHandles[4],double frequency,int options,double pointSize,double _coloringDistances[2],double scalingFactor,int newPointCloudHandle);
